...
browser: ['⚚°HW MODS WA°⚚','Safari','1.0.0'],
auth: state})
//=================================================//
...
let link = `https://youtube.com/channel/UCgaBeuxpMupEABSwJFU3koQ`
let buttons = [
{buttonId: `HimaruVipMods.☆`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
...
caption: he,
footer: `© HimaruVipMods.☆`,
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title: `Jangan Lupa Tersenyum ☺️`,
body: `SUBSCRIBE HimaruVipMods.☆`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
mediaUrl: link,}}}
